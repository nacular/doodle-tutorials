...
import RunnerGradle      from '!!raw-loader!../../ContactsRunner/build.gradle.kts';
...
[ScrollPanel](https://nacular.github.io/doodle-api/core/io.nacular.doodle.controls.panels/-scroll-panel), and
[`HyperLink`](https://nacular.github.io/doodle-api/controls/io.nacular.doodle.controls.buttons/-hyper-link).
...
[`DynamicTable`](https://nacular.github.io/doodle/docs/ui_components/overview#table),
...
:::tip
ContactList uses a [`SingleItemSelectionModel`](https://nacular.github.io/doodle-api/controls/io.nacular.doodle.controls/-single-item-selection-model)
...
The `ContactList` uses a custom [`TableBehavior`](https://nacular.github.io/doodle-api/controls/io.nacular.doodle.controls.table/-table-behavior)
...
to behave like a normal link, but fully customize the rendering. This is why we need to use `linkStyler`, which is a [`NativeHyperLinkStyler`](https://nacular.github.io/doodle-api/themes/io.nacular.doodle.theme.native/-native-hyper-link-styler).
:::
