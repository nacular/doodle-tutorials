...
:::warning
The desktop application uses placeholder icons in some cases to work-around a known [Skiko bug](https://github.com/JetBrains/skiko/issues/518) related to SVG path data parsing.
:::
