...
import PhotoStreamApp     from '!!raw-loader!../../PhotoStream/src/main/kotlin/io/nacular/doodle/examples/PhotoStreamApp.kt';
import UnSplashDataModel  from '!!raw-loader!../../PhotoStream/src/main/kotlin/io/nacular/doodle/examples/UnSplashDataModel.kt';
import CenterCroppedPhoto from '!!raw-loader!../../PhotoStream/src/main/kotlin/io/nacular/doodle/examples/CenterCroppedPhoto.kt';
...
Our application will be fairly simple. It will create a [`DynamicList`](https://nacular.github.io/doodle/docs/ui_components/overview#list)
with a data model bound to Unsplash's APIs. This list will be within a [`ScrollPanel`](https://nacular.github.io/doodle-api/core/io.nacular.doodle.controls.panels/-scroll-panel)
that fits the [`Display`](https://nacular.github.io/doodle/docs/display/overview) height.
