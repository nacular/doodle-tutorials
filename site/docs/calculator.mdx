...
The calculator buttons come in a few different color schemes. But they all share the same [`Behavior`](https://nacular.github.io/doodle/docs/rendering/behaviors),
